// Supabase client for Telegram bot - mirrors the web app functionality
...
if (supabaseUrl && supabaseKey) {
  ...
  console.log('✅ Supabase connected for Telegram bot')
} else {
  console.log('❌ Supabase not configured - missing URL or key')
}

// Save message to Supabase (same as web app)
export async function saveMessage(role, text, userId = 'telegram_user') {
